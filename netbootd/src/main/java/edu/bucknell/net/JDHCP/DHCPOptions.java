...
public class DHCPOptions {
	...
	public static final int OPTION_TFTP_SERVER = 66;
	public static final int OPTION_PXE_FILE = 67;
	public static final int OPTION_NEXT_SERVER = 150;
	...
	public void removeOption(byte entryCode) {
		optionsTable.remove(Byte.valueOf(entryCode));
	}
	...
	public boolean contains(byte entryCode) {
		return optionsTable.containsKey(Byte.valueOf(entryCode));
	}
	...
	public byte[] getOption(byte entryCode) {
		if (this.contains(entryCode)) {
			DHCPOptionsEntry ent = optionsTable.get(Byte.valueOf(entryCode));
			return ent.content;
		}
		else {
			return null;
	...
	public void setOption(byte entryCode, byte value[]) {
		...
		optionsTable.put(Byte.valueOf(entryCode), opt);
	}
